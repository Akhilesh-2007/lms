  ...
  return courseData ? (
    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        ...
        text-course-details-heading-small font-semibold text-gray-800'>{courseData.
        courseTitle}</h1>
        ...
        {/*review and ratings*/}
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>Trainly</span></p>
                        ...
                        border-t border-gray-300'>
                          {chapter.chapterContent.map((lecture, i) => (
                            <li key={i} className='flex items-start gap-2 py-1'>
                              <img src={assets.play_icon}alt='play icon'  className='w-4 h-4 mt-1 ml-2' />
      ...
      <div
        className="
        max-w-course-card z-10 bg-white rounded-lg overflow-hidden
        shadow-lg ring-1 ring-black/5 min-w-[300px] sm:min-w-[420px]">
            {
                playerData ? (

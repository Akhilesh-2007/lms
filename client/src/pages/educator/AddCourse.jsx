      ...
      <form onSubmit={handleSubmit} action="">
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            value={courseTitle} type="text" placeholder="Type here" className="outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500"
            required/>
        </div>
        <div className='flex flex-col gap-1'>
                  ...
                  {chapter.chapterContent.map((lecture,lectureIndex)=>(
                    <div key={lectureIndex} className='flex justify-between
                      ...
                      <span>
                        ...
                        <a href={lecture.lectureurl}target="_blank"className="text-blue-500">Link
        ...
        {submitMessage && (
          <p className='my-2 text-sm text-gray-700'>{submitMessage}</p>
        )}
        <button type='submit' className='bg-black text-white w-max py-2.5 px-8
        rounded my-4 disabled:opacity-70' disabled={isSubmitting}>

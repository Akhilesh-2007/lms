...
const Navbar = () => {
  ...
  const {navigate,isEducator,backednUrl:backendUrl,setIsEducator,getToken}=useContext(AppContext)
  ...
  return (
      <div className={`flex items-center justify-between px-4 sm:px-10 md:px-14 lg:px-36 border-b border-gray-500 py-4 ${isCourseListPage ? 'bg-white' : 'bg-cyan-100/70'}`}>
        <img onClick={()=>navigate('/')} src={assets.logo} alt="Logo" className='h-10 md:h-12 w-auto object-contain cursor-pointer' />
